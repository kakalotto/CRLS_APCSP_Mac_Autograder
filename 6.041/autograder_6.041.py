    ...
    if do_this_file:
        for key in name_dictionary.name_dict:
            ...
            if match and not match2:
                ...
                rubric_file = name_dictionary.name_dict[key] + ' - Python 6.041 Mr. Kanns spaghetti empire - Rubric'
            ...
            #    print(rubric_file)
                ...
                for file in response.get('files', []):
                    ...
                    cmd = ' cat ' + functions_filename + \
                        ' /Users/teacher/PycharmProjects/untitled/6.031/6.031.test.py > /tmp/6.031.test.py'
                    c = delegator.run(cmd)
