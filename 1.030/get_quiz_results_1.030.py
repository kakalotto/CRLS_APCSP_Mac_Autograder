...
quiz_spreadsheet_id ='1mkuwliqKkhS0i1i3PG6Kqb7fQ5dYtpFd-WhupIwrnQs'
...
for index, email in enumerate(emails, 0):
    ...
    rubric_file = names_to_emails.names_to_emails[email] + ' - Python 1.030 - Rubric'
    ...
    for file in response.get('files', []):
        ...
        # Sheets API to update score (F12)
        range_name = 'Sheet1' + '!F12'
